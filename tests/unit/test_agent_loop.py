...
async def _noop(args: dict[str, Any], ctx: Any, scope: Any = None) -> str:
    return "ok"
...
class TestAgentLoop:
    ...
    async def test_multi_turn_with_tool(self) -> None:
        ...
        async def add(args: dict[str, Any], ctx: Any, scope: Any = None) -> str:
            calls.append(args)
    ...
    async def test_tool_error_is_fed_back_to_llm(self) -> None:
        async def boom(args: dict[str, Any], ctx: Any, scope: Any = None) -> str:
